...
(function (root, factory) {
  ...
  function decodeSize($this, source, startIndex, endIndex) {
    ...
    Default_getInstance();
    var tmp3_div = 8;
    tmp$ret$1 = tmp2_div.div_9s1fi3_k$(toLong(tmp3_div));
  ...
  protoOf(Companion_21).get_MIN_VALUE_7nmmor_k$ = function () {
    return this.MIN_VALUE_1;
  };
  protoOf(Companion_21).get_MAX_VALUE_54a9lf_k$ = function () {
    return this.MAX_VALUE_1;
  };
    ...
    while (true) {
      ...
      if (completion instanceof CoroutineImpl) {
        ...
        if (!(currentException == null)) {
          ...
          var tmp$ret$4;
          // Inline function 'kotlin.Companion.success' call
          var tmp2_success = Companion_getInstance_12();
  ...
  _.$_$.l = objectMeta;
  _.$_$.m = protoOf;
  _.$_$.n = setMetadataFor;
  _.$_$.o = toByte;
  _.$_$.p = decodeToString;
